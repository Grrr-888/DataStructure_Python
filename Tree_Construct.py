...
class Tree_Construct(Tree):
    ...
    #     self.__Construct_With_In_Post(self.In_Order_Seq, self.Post_Order_Seq)

        
    # def __Construct_With_In_Post(self, in_order_seq, post_order_seq):

    #     root = self.Post_Order_Seq[-1] # Post order last char is root
    #     pass
